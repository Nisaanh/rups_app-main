<x-app-layout>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-200/60 overflow-hidden">
                        ...
                        <form action="{{ route('arahan.store') }}" method="POST" class="px-8 pb-8 pt-4 md:px-10 md:pb-10 md:pt-6 space-y-6">
                            ...
                            {{-- After Save Option --}}
                            <div class="bg-blue-50/50 p-4 rounded-xl border border-blue-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">

                                <span class="text-[9px] font-black text-blue-800 uppercase tracking-wide">
                                    Opsi Setelah Simpan:
                                </span>
                                ...
                                <div class="flex flex-wrap gap-3 md:gap-5">
                                    ...
                                    <label class="inline-flex items-center cursor-pointer group">
                                        <input type="radio"
                                            ...
                                            value="continue"
                                            checked
                                            class="text-blue-600 focus:ring-blue-500 w-3.5 h-3.5 border-slate-300">

                                        <span class="ml-1.5 text-[10px] font-bold text-blue-700 uppercase tracking-tight">
                                            Input Arahan Lagi
                                        </span>
                                    </label>
                                    ...
                                    <label class="inline-flex items-center cursor-pointer group">
                                        ...
                                        <span class="ml-1.5 text-[10px] font-bold text-slate-500 uppercase tracking-tight">
                                            Kembali ke Detail
                                        </span>
                                    </label>
                                </div>
                            ...
                            <div class="pt-4 flex justify-end">
                                <button type="submit"
                                    class="w-full md:w-auto px-6 py-2.5 bg-slate-900 text-white rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-blue-600 shadow-lg shadow-slate-200 hover:shadow-blue-200 transition-all active:scale-95 flex items-center justify-center">
    ...
    <script>
       const usersData = JSON.parse('{!! addslashes(json_encode($users->map(fn($u) => ["id" => $u->id, "name" => $u->name]))) !!}');
